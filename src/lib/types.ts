...
export const FACTION_DEFINITIONS: Record<FactionType, FactionDefinition> = {
  radiant: {
    ...
    baseShape: 'square',
    ability: 'laser',
    availableUnits: ['marine', 'warrior', 'tank', 'scout', 'artillery', 'medic', 'interceptor', 'guardian'],
  },
  aurum: {
    name: 'Aurum',
    baseMoveSpeed: 3.0,
    baseShape: 'circle',
    ability: 'shield',
    availableUnits: ['snaker', 'berserker', 'assassin', 'juggernaut', 'striker', 'reaper', 'oracle', 'harbinger'],
  },
  solari: {
    name: 'Solari',
    baseMoveSpeed: 2.0,
    baseShape: 'star',
    ability: 'pulse',
    availableUnits: ['flare', 'nova', 'eclipse', 'corona', 'supernova', 'zenith', 'pulsar', 'celestial'],
  },
};
...
export type UnitType = 'marine' | 'warrior' | 'snaker' | 'tank' | 'scout' | 'artillery' | 'medic' | 'interceptor' | 'berserker' | 'assassin' | 'juggernaut' | 'striker' | 'flare' | 'nova' | 'eclipse' | 'corona' | 'supernova' | 'guardian' | 'reaper' | 'oracle' | 'harbinger' | 'zenith' | 'pulsar' | 'celestial';
